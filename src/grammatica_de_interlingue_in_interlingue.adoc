...
:revnumber: 0.1.0-pre.26+20200404
...
// XXX FIXME -- «-ore» es *anc* un productiv sufixe:
...
// XXX REMARK -- Li tre ultim exemples ne rilate li explication:
