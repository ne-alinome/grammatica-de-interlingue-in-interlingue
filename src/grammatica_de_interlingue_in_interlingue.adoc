...
:revnumber: 0.1.0-pre.46+20200727
...
[width=100%]
|===
| Infinitive{blank}footnote:[{pednote1677}] | seder    | ceder    | verter    | venir    | tener
| Tema perfectic                            | sess     | cess     | vers      | vent     | tent
| Vice                                      | _ses_    | _ces_    | _vert_    | _venit_  | _ten_
| -ion                                      | session  | cession  | version   | vention  | tention
| Vice                                      | _sesion_ | _cesion_ | _vertion_ | venition | _tenion_
|===
