...
:revnumber: 0.1.0-pre.41+20200713
...
y consonantic:: Quam A, F: _yeux_, G: «j», H: _ayustar_.
+
====
yes, rayon, anteyan.
====
...
poc modificat e movet ante li complet liste de exemples. Editor
digital.]:

// XXX FIXME -- «fèlici» contradi li regul pri «ic» con son «ik».
...
// XXX TODO -- «indicar que li precedent [ACCENTUAT] vocal es curt».
...
quelc usat derivates del 11 verbes. Por claritá, ti-ci edition \
have un sol grand tabelle con omni possibil derivates, mem tis \
ordinarimen ne usat. Editor digital. \
...
// XXX OLD -- 2020-04-04: Prova. Tabelles individual, ancor con omni
// possibil combinationes. Ti metode es rejectet, nam it es minu
// legibil quam un sol tabelle.
...
// XXX NEW -- Plu clar alternative, con temas perfectic regulari e
// ínregulari:

:pednote1677: Por claritá, anc li temas perfectic, regulari e \
ínregulari, es includet in li tabelle in ti edition. Editor digital.


[width=100%]
|===
| Infinitive{blank}footnote:[{pednote1677}] | Tema perfectic | Vice | -ion | Vice

| seder      | sess           | _ses_   | session | _sesion_
| ceder      | cess           | _ces_   | cession | _cesion_
| verter     | vers           | _vert_  | version | _vertion_
| venir      | vent           | _venit_ | vention | _venition_
| tener      | tent           | _ten_   | tention | _tenion_
|===
...
prescrition» esset deletet ex ili, nam it ne relatet al afere. Editor
digital.]
...
// XXX TODO -- del eclesia -> pri li eclesia ?
...
// XXX FIXME -- Ti tabelle ne have plazza; fórsan in du columnes:
...
// XXX TODO -- pednote pri ti frases:
