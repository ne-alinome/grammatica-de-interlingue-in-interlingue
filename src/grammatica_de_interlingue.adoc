...
:revnumber: 0.1.0-pre.18+20190808
...
A (anglesi): _father_. *vase, batte, batter*.

e:: Apert o cludet, quam GHI, A: _bed, yes_, F: "`é`" o "`è`". *pena,
mensu, pelle, venir*.

i:: Quam FGHI, A: _machine_. *nive, six, minute*.

o:: Apert o cludet, quam FGHI, A: _door, hot_. *modic, póndere, porta,
ponderar*.

u:: Quam GHI, A: _rule, pull_, F: "`ou`"; pos "`q`" tre curt, presc
consonantic ("`w`"). *brun, mult, sudar, quar*.
...
Interlingue "`i`": *physica*.

De du o pluri *vocales succedent* chascun es pronunciat. Inaccentuat
...
s:: Sonori inter vocales, dur in omni altri casus.
+
====
