...
:revnumber: 0.1.0-pre.87+20201101
...
[[par80,§80]]§80. Li sufixes: *<<sufixe_ion>>, <<sufixe_or>>, <<sufixe_ori>>,
<<sufixe_iv>>, <<sufixe_ura>>* ne es adjuntet al tema verbal o al tema presentic,
...
On posse anc dir, que li sufixes: *<<sufixe_ion>>, <<sufixe_or>>, <<sufixe_ori>>,
<<sufixe_iv>>* e *<<sufixe_ura>>* es adjuntet che li verbes con *ar* e *ir* al
...
presentic
*-nt* con li sufix *<<sufixe_ie>>*.

// XXX FIXED -- "presen-tic" -> "presentic":

[[par83,§83]]§83. In analog maniere adjunte se li sufix *<<sufixe_nd>>* al tema
presentic:
...
[[par84,§84]]§84. Anc li sufix *<<sufixe_ment>>* es adjuntet al tema presentic:
...
secun li vocal caracteristic: *<<sufixe_bil,-abil>>, <<sufixe_da,-ada>>* ye *a*
respectivmen *<<sufixe_bil,-ibil>>, <<sufixe_da,-ida>>* ye *i* o *e*:
...
+
--
[[sufixe_ion,-ion]]-ion:: Action, anc resultat e loc de it: *administration, expedition,
construction, distribution, explosion*.

[[sufixe_or,-or]]-or:: Actent person, cose o factor: *administrator, expeditor,
distributor, constructor, ventilator, compressor, divisor*.

[[sufixe_ura,-ura]]-ura:: Concretisat action e su resultate: *reparatura, garnitura,
lectura, creatura*.
--
...
+
--
[[sufixe_ment,-ment]]-ment:: Concret action o su resultate, o servient a, servient quam:
...
+
--
[[sufixe_da,-da]]-ida (verbes in *-ar*: *-ada*):: Action in durada: *promenada, perdida,
currida*.
--
...
+
--
[[sufixe_ie,-ie]]-ie:: Statu in durada: *tolerantie, provenientie, existentie*.
--
...
[[sufixe_er,-er]]-er:: Person professional: *molinero, lavera, librero, vitrero*.
...
francesi, borgeso*. Cp. <<sufixe_an,«-an»>>.
...
[[sufixe_ie,-ie]]-ie:: Abstract substantives, statu (cp. <<par82>>, <<par136>>):
...
[[sufixe_ia,-ia]]-ia:: Loc, land: *dormitoria, Germania, dominia, abatia*.

-eríe:: Profession e su productes (*<<sufixe_er>>* + *<<sufixe_ie>>*), metaforicmen
anc maniere de acter, caractere: *vitreríe, potteríe, bigotteríe, diaboleríe*.

-ería:: Loc de profession (*<<sufixe_er>>* + *<<sufixe_ia>>*): *librería,
juvelería, vitrería*.
...
acter talmen (adjective de *<<sufixe_or>>*): *decoratori, obligatori, consolatori,
...
-ore*{blank}footnote:[<<sufixe_ic,«-ic»>> e <<sufixe_ore,«-ore»>> es anc productiv
