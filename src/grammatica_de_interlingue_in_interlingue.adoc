...
:revnumber: 0.1.0-pre.103+20201120
...
ma ne sur li quar síllabes *bil, ic{blank}footnote:[Solmen quande it es
pronunciat «ik». Vide «Complet grammatica de Occidental» in Cosmoglotta series
A, numeró 65, 1929-10. Note del editor digital.], im, ul*, queles porta li
accentu al precedent Síllab, mem si ti-ci es *bil, ic, im, ul*. Un
...
autor parla ne pri qualcunc parol-fine, ma pri li terminationes «-s»
...
81 (1946-05). Por claritá li descritiones de «caus» e «pro» esset rescrit pos
...
// "Multis vell prefer viver in li rure" ->
