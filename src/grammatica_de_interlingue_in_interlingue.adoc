...
:revnumber: 0.1.0-pre.76+20201031
...
:pednote1976: Li edition original ne includet descritiones, solmen exemples. \
To fat desfacil comprender li precis signification de quelc prepositiones. \
Por claritá, \
ti edition include descritiones, adaptat ex li articul de Alphonse Matejka \
«Signification del prepositiones (cardinal senses)», publicat in \
Cosmoglotta B 81 (1946-05). Note del editor digital.

// Prepositiones {{{1
== Prepositiones{blank}footnote:[{pedtone1976}]
...
// XXX REMARK Secun Matejka, anc «in sam témpor»:
...
// XXX REMARK Secun Matejka, anc «sequentie»:
...
// XXX FIXME «contra» e «ye li látere de» es íncomprensibil sin exemples. Vide
// li original de Matejka.
