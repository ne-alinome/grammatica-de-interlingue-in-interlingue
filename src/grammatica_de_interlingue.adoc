...
§{nbsp}1. Interlingue es scrit per 26 *lítteres latin: a, b, c, d, e, f, g,
h, i, j, k, I, m, n, o, p, q, r, s, t, u, v, w, x, y, z.*

§{nbsp}2. Li alfabet es *pronunciat:*
...
§{nbsp}3. *Li vocales* es sempre clarmen pronunciat quam seque:
...
§{nbsp}4. In general *vocales accentuat* es passabilmen *long;* ma avan *c
...
§{nbsp}5. *Li consonantes* es pronunciat quam seque:
...
§{nbsp}6. Li experientie pruva que *litt variationes* in li pronunciation ne
...
§{nbsp}7. *Paroles extran* es pronunciat maxim possibil quam in li lingue de
orígine.
...
§{nbsp}8. *Li accentu primari* sta sur li vocal ante li ultim consonant, ma
...
§{nbsp}9. In li *fluent parlada* on ne accentua chascun parol secun li
...
§{nbsp}10. Interlingue conserva maxim possibil li *aspect international* del
...
§{nbsp}11. Li *grec gruppes de consonantes: th, chl, chr, ph* es in general
...
§{nbsp}12. Li *separation sillabic* es líber; preferibil es li separation usat
in parlada o secun li parol-componentes.

§{nbsp}13. *Majuscules* es usat solmen in li comensa del frases, in propri
...
§{nbsp}14. Li *acurtationes* maxim frequent es:
...
§{nbsp}15. In Interlingue existe un sol *articul definit: li,* por li
...
§{nbsp}16. Un *articul índefinit* existe solmen por li singulare: *un.*
...
§{nbsp}17. Li articul *li* posse *prender li plurale,* si null altri parol
expresse it.
...
§{nbsp}18. *A li* es contractet a *al*, *de li* a *del*.

====
Il eat al scol. Li árbores del forest es alt.
====

§{nbsp}19. Un *articul partitiv* ne existe.

====
Il trinca aqua. Noi manja fructes.
====

§{nbsp}20. Li articul *definit* indica alquó ja mentionat o conosset, o li
...
§{nbsp}21. Interlingue lassa al paroles lor *desinenties natural,* e ne
...
§{nbsp}22. Li *neutral vocal final -e* trova se in mult substantives por
...
§{nbsp}23. Un *génere grammatical* ne existe. Omni substantives es
masculin, feminin o neutri secun lor signification.

§{nbsp}24. On posse indicar li génere in li nómines por entes: *-o* indica li
...
§{nbsp}25. Quelc substantives forma derivates per adjunter *u* resp. *at* al
...
§{nbsp}26. Por indicar li *plurale* on adjunte *-s*, pos consonantes
...
§{nbsp}27. Li substantive resta ínmutat in omni *casus grammatical.* Es
...
§{nbsp}28. *Propri nómines* es changeat minim possibil. Por li principal
...
§{nbsp}29. Li caracteristic vocal final *-i* trova se in mult
...
§{nbsp}30. Mult adjectives posse facilmen esser *substantivat* per adjuntion
del finales *-e, -o, -a.*
...
§{nbsp}31. Por formar un substantive expressent li *general idé* de un qualitá
...
§{nbsp}32. Li adjective es *ínvariabil* in génere e númere. _li grand filio,
li grand filia, li grand filios, li grand filias._

§{nbsp}33. Quande li adjective es usat sin substantive e on deve pro cert
...
§{nbsp}34. Por li *comparative* on indica
...
§{nbsp}35 Por li *superlative* on indica
...
§{nbsp}36. Por li *superlative absolut on* usa: *tre,* o li sufix:
*-issim*.
...
§{nbsp}37. In omni comparationes on usa: *quam.*
...
§{nbsp}38. *Adjectivic pronómines* es tales queles sta avan o pos un
...
§{nbsp}39. It existe *du formes,* li un por li *subject* (nominative), li
...
§{nbsp}40. Li pronómin de *politesse* es: *vu* (cf. § 13). On usa it vice tu,
quel expresse un cert intimitá o parentitá.

§{nbsp}41. Li pronómin *índefinit* es: *on,* li *reflexiv: se,* li *reciproc:
unaltru.*
...
§{nbsp}42. *Pos prepositiones* on usa li acusative, o li nominative except
yo e tu.
...
§{nbsp}43. Li formes *adjectivic e substantivic* es egal; ma por li
...
§{nbsp}44. Li formes *adjectivic e substantivic* es egal; ma li substantivics
prende li plurale e posse prender li sexu, si to in rar casus es
necessi.

§{nbsp}45. Por monstrar alquó on usa generalmen: *ti.* Solmen si on vole
...
§{nbsp}46. *Ti, tal e tant* es li corelatives de *quel, qual e quant.* (Tant
...
§{nbsp}47. Li *neutri form* por coses e factes es: *to,* respondent al
...
§{nbsp}48. Li *pronómin o articul lu* servi por expresser to quo es
...
§{nbsp}49. On usa li sam pronómines, relativ e interrogativ, adjectivic e
substantivic.

§{nbsp}50. Li *maxim general es: quel* (plural: *queles),* usat por coses,
factes e persones.
...
§{nbsp}51. Por *coses e factes* on usa: *quo,* por *persones: qui.*
...
§{nbsp}52. Si *pluri relationes* de un pronómin relativ es possibil, li
...
§{nbsp}53. Por expresser li *qualitá* on usa: *qual,* por li *quantitá:
quant.*
...
§{nbsp}54. Li prefix: *al-* da pronómines indicant alquó índeterminat, li
...
§{nbsp}55. Altri *pronómines índefinit es:*
...
§{nbsp}56. Li *númeres cardinal* es:
...
§{nbsp}57. Li *númeres ordinal* es format per adjunter li finale:
*-esim. unesim* (apu *prim), duesim* (apu *secund), triesim,* etc.

§{nbsp}58. Li *númeres fractionari* es egal al ordinales, ma ordinarimen
...
§{nbsp}59. Li *fractiones decimal* es pronunciat

- 3,78349 = tri comma sett ott tri quar nin,
- 0,25 = null comma du quin.

§{nbsp}60. Li *numerales multiplicativ* es format per adjunter li finale
...
§{nbsp}61. Li *numerales iterativ* es format per: *vez.*

====
du vez o duvez, tri vez, centvez, mult vez o multvez o mult vezes.
====

§{nbsp}62. Li *numerales colectiv* es format per li finale: *-ene.*

====
li unité, pare, triene, quarene, quinene, decene, deciduene, centene.
====

§{nbsp}63. *Altri numeral expressiones* es p. ex.:
...
§{nbsp}65. In Interlingue existe *un sol* e *unitari conjugation* per
adjuntion de cert consonantes al tema presentic.

§{nbsp}66. Li *tema presentic* es format per adjunter un del tri vocales
...
§{nbsp}67. Li unesim, duesim e triesim person, singulare e plurale, es
distinctet solmen per li pronómin; li verb self resta ínmutat.

§{nbsp}68. Li *infinitive* es format per adjunter *-r* al tema presentic:
...
§{nbsp}69. Li *presente* es egal al tema presentic:
...
§{nbsp}70. *Li participie passat* (anc *participie passiv)* es format per
...
§{nbsp}71. Omni *composit témpores passat* es format per li verb auxiliari
...
§{nbsp}72. Li *future simplic* es format per li auxiliare *va:*
...
§{nbsp}73. Li *conditionale simplic* es format per li auxiliare *vell*:
...
§{nbsp}74. Li *participie presentic* (anc *participie activ)* es format
...
§{nbsp}75. Li *imperative* es egal al presente sin pronómin:
...
§{nbsp}76. Li *optative* es format per *mey* con infinitive:
...
§{nbsp}77. Li *formes passiv* es format per li verb auxiliari *esser:*
...
§{nbsp}78. *Vice li subjuntive* on usa in general li indicative. Solmen in
...
§{nbsp}79. In omni lingues milles de substantives e adjectives es format ex
...
§{nbsp}80. Li sufixes: *ion, or, ori, iv, ura* ne es adjuntet al tema verbal o
...
On posse anc dir, que li sufixes: *-ion, -or, o-ri, -iv* e *-ura* es adjuntet
che li verbes con *ar* e *ir* al participie passat, ye li verbes con
*er* al
...
§{nbsp}81. Che li tri verbes: *far, dir, scrir* on posse formar li derivates
...
§{nbsp}82. Li *finale -ntie* es adjuntet al tema presentic de verbes
...
§{nbsp}83. In analog maniere adjunte se li sufix *-nd* al tema presentic:
...
§{nbsp}84. Li sufix *-ment* anc es adjuntet al tema presentic:
...
§{nbsp}85. Du sufixes adjunte se al radica verbal in du formes diferent secun
...
§{nbsp}86. *Li altri sufixes* es adjuntet directmen al radica verbal:
...
§{nbsp}87. *Substantivation direct:* On posse anc usar quam substantive li
...
§{nbsp}88. Por *indicar un qualitá* de un substantive on usa un adjective,
...
§{nbsp}89. In Interlingue on posse usar li adjective vice li adverbie, si li
sens es clar.
...
§{nbsp}90. It existe *adverbies primari* sin special finale, e *adverbies
...
§{nbsp}91. Vice special adverbies on usa multvez *adverbial expressiones,*
...
§{nbsp}92. Li *comparative e superlative* es format in li sam maniere quam
in li adjectives.
...
§{nbsp}93. Secun li sens on posse *gruppar li adverbies* in adverbies de
maniere, de quantitá, de loc, de témpor, e adverbies afirmativ, negativ
e de dúbit.

§{nbsp}94. Li *adverbies de maniere* responde al question: *qualmen?*
...
§{nbsp}95. Li *adverbies de quantitá* responde al question: *quant?*
...
§{nbsp}96. Li *adverbies de loc* responde al question: *u,* *a u,* *de* *u?*
...
§{nbsp}97. Li *adverbies de témpor* responde al question: *quande?*
...
§{nbsp}98. Li *adverbies de afirmation, negation, dúbit* es: *yes, no, ne, ne
...
§{nbsp}99. Omni prepositiones sta *ínmediatmen avan lor complement.* lli es
ínvariabil.

*Pos prepositiones* on usa li *acusative* del pronómines, o li
nominative except yo e tu.

§{nbsp}100. Li *usation del prepositiones* in li lingues national es
...
§{nbsp}101, Multvez li relation es clar anc *sin preposition.* Li *verbes* es
...
§{nbsp}102. Li *maxim frequent prepositiones* es:
...
+
====
Mult persones vive in li cité. Multís vell preferer viver in li
...
+
====
Malgré su grand efortíes il ne posset perforar li mur. med:
...
§{nbsp}103. Mult *prepositional expressiones* es format per adverbies e
adjectives:
...
§{nbsp}104, Conjunctiones de *coordination* es:
...
§{nbsp}105. Conjunctiones de *subordination* es: *que, si, quam, esque, ca,
quasi, benque, etsí.*
...
§{nbsp}106. Mult conjunctiones e conjunctional expressiones es *composit* ex
...
§{nbsp}107, Quam interjectiones on posse usar omni interjectiones del national
...
§{nbsp}108. Li *position* del paroles in li frase es in general *líber* til un
...
§{nbsp}109. Li frase es maxim bon comprensibil, si omni paroles sta maxim
...
§{nbsp}110. De to seque, que li *adjective* o atribut adjectivic deve preceder
...
§{nbsp}111. Li *adverbies: ne, tre, tro, solmen* e *anc* deve sempre *preceder
...
§{nbsp}112. Li *verbes auxiliari* (anc: dever, posser, voler etc.) deve sempre
...
§{nbsp}113. Negativ pronómines e adverbies recive li sens positiv solmen si
...
§{nbsp}114. Anc in li *frases relativ* on usa li *sam órdine* del frase-partes
...
§{nbsp}115. Li *acusativ pronómin* seque ínmediatmen li verb; li *dativ
...
§{nbsp}116. Li regules indicat por frases direct vale anc por *frases
...
§{nbsp}117. Verbes es usat maxim possibil *transitivmen, personalmen* e
...
§{nbsp}118. Li signes de interpunction deve esser usat talmen, que li
...
§{nbsp}119. Li *punctu* (*.*) indica un stoppa passabilmen grand. It es usat
por separar complet frases, expressent un pensa terminat.

§{nbsp}120. Li *punctu-comma* (*;*) indica un stoppa min grand. It es usat por
...
§{nbsp}121. Li *comma* (*,*) indica li minim grand stoppa. It es usat por
...
§{nbsp}122. Por indicar li paroles maxim important del frase on posse usar li
*accentu scrit.*
...
§{nbsp}123. Li *altri signes de interpunction:*
...
§{nbsp}124. *Nov paroles* es format per:
...
§{nbsp}125. Li adjuntion de desinenties es ja tractat in li concernent
...
§{nbsp}126. Ti desinenties es un consequentie del *caracterisant vocales
...
§{nbsp}127. In mult international parolformationes li prefixes e prefixial
...
§{nbsp}129. Quam prefixes on usa anc *prepositiones, adverbies e li presente*
de quelc verbes:
...
§{nbsp}130. Mult international paroles es format per *grec prefixes:*
...
§{nbsp}131. Li sufixes adjunte se al radica ínmediatmen o med vocales o
...
§{nbsp}132. In mult international parolformationes existe un *contraction* de
...
§{nbsp}134. *Finale -ar.* Omni modern formationes de verbes fini per -ar, ne
...
§{nbsp}136. *Sufixes por verbal substantives.*
...
francesi, borgeso.* *-ane, -ano, -ana*: cp. § 140.
...
§{nbsp}139. *Local e colectiv sufixes.*
...
§{nbsp}141. Mult paroles international contene *grec e latin afixes:*
...
§{nbsp}142. Ultra li indicat *productiv afixes* existe quelc *ínproductiv
...
§{nbsp}143. Maxim frequent es li metode plazzar li complement sin preposition
