...
:revnumber: 0.1.0-pre.70+20201031
...
representa pluri fonemes secun su position in li parol e li region del
parlator. Mult ex ti pronunciationes es diferent de «y» in Interlingue. Li max
simil son, secun li pronunciation normativ del lingue hispan, es ti de «hi» in
li parol _hierro_, it es li foneme /j/. Note del editor digital.].
+
====
yes, rayon, anteyan.
====
