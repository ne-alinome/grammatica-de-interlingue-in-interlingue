...
:revnumber: 0.1.0-pre.13+20190320
...
- Amelioration del leibilitá por omni formates, precipue de tabelles e
  listes.
- Creation de intern ligamentes.

Edition fat solmen per líber programas:: 
...
"`A`", "`i`", "`u`" have sempre un medial sonalitá bon distinctibil
