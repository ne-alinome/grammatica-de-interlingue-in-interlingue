...
§{nbsp}79. In omni lingues millenes de substantives e adjectives es format ex
...
§{nbsp}83. In analog maniere adjunte se li sufix *-nd* al tema presen-tic:
