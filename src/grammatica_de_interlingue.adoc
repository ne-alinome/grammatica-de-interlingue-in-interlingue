...
Principal changes fat in ti edition::

- Omni trovat erras ha esset corectet.
- Tabelles, listes e altri partes ha esset modificat por ameliorar lor
  leibilitá in omni formates.
