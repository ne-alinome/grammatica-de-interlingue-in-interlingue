...
:revnumber: 0.1.0-pre.28+20200404
...
http://ne.alinome.net[_ne alinome_ (ne.alinome.net)] ye formates EPUB, PDF e altris.
...
benevenit che http://ne.alinome.net[_ne alinome_ (ne.alinome.net)].
...
a:: Quam in F (francesi), o G (german), o H (hispan), o I (italian), o
A (anglesi): _father_.
+
====
vase, batte, batter.
...
e:: Apert o cludet, quam GHI, A: _bed, yes_, F: «é» o «è».
+
====
pena, mensu, pelle, venir.
====

i:: Quam FGHI, A: _machine_.
+
====
nive, six, minute.
====

o:: Apert o cludet, quam FGHI, A: _door, hot_.
+
====
modic, póndere, porta, ponderar.
====

u:: Quam GHI, A: _rule, pull_, F: «ou»; pos «q» tre curt, presc
consonantic («w»).
+
====
...
consonantic, altriloc vocalic.  *y vocalic* es pronunciat quam in
Interlingue «i»:
+
====
*physica*.
...
b, d, f, I, m, n, p:: Quam in AFGI, H («b» in _boca_).
+
====
...
ch:: F, A: «sh», G: «sch», permisset anc A: «ch», H: «ch», ma
...
g:: Avan «e», «i», «y»: AFI, G: dulci «sch» quam in _generös_,
altriloc AFGHI («gn» maxim possibil «g-n», ne «nye»).
+
====
...
j:: Quam F, A: _vision_, G: dulci «sch» quam _Journal_, dunc quam in
...
qu:: Quam «k», sempre sequet de tre curt «u»: AGI, F e H con
«u».
+
====
quar, aqua.
...
sh, sch:: Quam A: «sh», F: «ch», G: «sch». Existe solmen in
...
ne un «s» precede, altriloc quam AFGHI.
+
====
...
w:: Rar, quam A, curt «u» in Interlingue.
+
====
west.
====

x:: Dur o dulci, quam AFG, H: _examinar_.
+
====
examinar, extra.
====

y consonantic:: Quam A, F: yeux, G: «j», H: _ayustar_.
+
====
yes, rayon, antey.
====
...
pronunciar li «y» vocalic quam F: «u», G: «ü», *qu* quam «kw»,
...
consonant, ma ne sur li quar síllabes *bil, ic, im, ul*, queles porta
li accentu al precedent síllab, mem si ti-ci es *bil, ic, im, ul*. Un
...
del plural, «-men» del adverbies e li sufixe «-um». Editor digital.].
...
// XXX FIXME -- 2019-08-09: Li comensa original esset:
//
...
// íntrovabil. E li note esset rescrit e convertet in pednote, por claritá.

====
Li famìlie(*){blank}footnote:[In ti exemples, li autor usa li accentu acut por
marcar accentus scrit, quo es li usation normal in Interlingue, e li accentu
grav por monstrar li accentus ínscrit. Editor digital.], àvie, doctòr, formàr,
li formàt, li formàte, formànt; duràbil, elèctric, lògic, li lògica, li lògico,
pràctic, li práctica, il pràctica, il ìndica, il èxplica, dùplic, il dùplica,
multìplic, il multìplica, centùplic, il centùplica, specìfic, il specìfica,
fèlici, ùltim, règul, hercùlic, li artìcul, il artìcula; mìnus, ìris, fòrmes,
families, àvies, generàlmen, enèrgicmen, li fenòmen, màximum, ultimàtum, li
...
dúbit, il dúbita; micro-còsmo, anglosaxònic, agricultùra, centimètre,
postcàrte, manuscrìte, genú-articulation, unifòrm, li unifòrme, il unifòrma, il
internationalìsa, ínpracticàbil, índubitàbilmen, li fèrro-vìa, il invìa, it
inflùe, il subtràe, hodíe, il contradí, il retrovèni.

// XXX TODO -- Confirmar «inscrí» o «ìnscri»: to es, esque prefixes ne
// changea li accentuation?

(*) In vocabulariums e manuales li scrition del acut es obligatori, ti del
gravis recomendat quam medie didactic por accentus ínscrit: inscrìt, il
...
// XXX TODO -- Decider pri ca metter "alcos" e li pednote o ne:
...
| alquí   | nequí   | quicunc
| alcun   | necun   |
| alcos{blank}footnote:[«alcos» mancat in li edition original.
It esset adjuntet in ti edition nam it es un forme frequent. In contrari, «cuncunc» e
«coscunc» nequande esset usat. Editor digital]
| necos   |
|===
...
// XXX FIXME -- This table is fine for PDF, but too wide for EPUB.

[width="100%"]
|===
| Infinitive  | Tema perfectic | -ion         | -or         | -ori         | -iv         | -ura
...
| revider     | revis          | revision     | revisor     | revisori     | revisiv     | revisatura
...
// XXX TODO -- Also all derivates? I.e. should the table show the alternative
// "tema perfectiv", e.g. "sess", "cess", "vers", "tent"?
...
paroles international. P. ex.: *-id, -ore*{blank}footnote:[«-ore» es
un ínproductiv afixe in cert casus, ma it es anc un productiv afixe.
Vide <<par138>>. Editor digital.].

// XXX REMARK -- Li tri ultim exemples ne rilate li explication:
